...
conv_image_1sig=image_log(:,:,1);           % output of the convolution with LoG with sigma = 1
conv_image_5sig=image_log(:,:,5);           % output of the convolution with LoG with sigma = 5
